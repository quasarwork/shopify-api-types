...
(function (CustomerMergeErrorCode) {
    ...
    /** To continue with override, disable the account for the duplicate customer. */
    CustomerMergeErrorCode["OverrideCustomerNotEnabled"] = "OVERRIDE_CUSTOMER_NOT_ENABLED";
...
(function (GateSubjectErrorCode) {
    /** Active gate limit reached. */
    GateSubjectErrorCode["ActiveGateLimit"] = "ACTIVE_GATE_LIMIT";
...
(function (ParseErrorCode) {
    ...
    ParseErrorCode["BinaryExpressionIncompatibleTypes"] = "BINARY_EXPRESSION_INCOMPATIBLE_TYPES";
    /** Column not found. */
    ...
    ParseErrorCode["CompareToWithoutDuring"] = "COMPARE_TO_WITHOUT_DURING";
    ...
    ParseErrorCode["ExcessGroupByAll"] = "EXCESS_GROUP_BY_ALL";
    ...
    ParseErrorCode["FunctionModifierInvalid"] = "FUNCTION_MODIFIER_INVALID";
    ...
    ParseErrorCode["GroupByAllDateRangeNotFound"] = "GROUP_BY_ALL_DATE_RANGE_NOT_FOUND";
    /** Function `GROUP BY` has too many projections. */
    ParseErrorCode["GroupByExcessProjections"] = "GROUP_BY_EXCESS_PROJECTIONS";
    /** Limit is invalid. */
    ...
    ParseErrorCode["VisualizeByOrOverNotFound"] = "VISUALIZE_BY_OR_OVER_NOT_FOUND";
    ...
    ParseErrorCode["VisualizeContainsByAndOver"] = "VISUALIZE_CONTAINS_BY_AND_OVER";
    ...
    ParseErrorCode["VisualizeExcessProjectionsAlpha"] = "VISUALIZE_EXCESS_PROJECTIONS_ALPHA";
    ...
    ParseErrorCode["VisualizeTypeNotFound"] = "VISUALIZE_TYPE_NOT_FOUND";
...
(function (WebhookSubscriptionTopic) {
    ...
    WebhookSubscriptionTopic["ApiClientActivity"] = "API_CLIENT_ACTIVITY";
    ...
    /** The webhook topic for `fulfillment_orders/hold_fulfillment` events. [Deprecated: subscribe to fulfillment_orders/placed_on_hold instead] Occurs whenever a fulfillment order is held. Requires at least one of the following scopes: read_merchant_managed_fulfillment_orders, read_assigned_fulfillment_orders, read_third_party_fulfillment_orders. */
    WebhookSubscriptionTopic["FulfillmentOrdersHoldFulfillment"] = "FULFILLMENT_ORDERS_HOLD_FULFILLMENT";
    ...
    /** The webhook topic for `fulfillment_orders/moved` events. Occurs whenever a fulfillment order is moved. Requires at least one of the following scopes: read_merchant_managed_fulfillment_orders, read_assigned_fulfillment_orders, read_third_party_fulfillment_orders. */
    ...
    /** The webhook topic for `fulfillment_orders/ready_for_pickup` events. [Deprecated: subscribe to fulfillment_orders/line_items_prepared_for_pickup instead] Occurs when a fulfillment order is in ready for pickup state. Requires at least one of the following scopes: read_merchant_managed_fulfillment_orders, read_assigned_fulfillment_orders, read_third_party_fulfillment_orders. */
    WebhookSubscriptionTopic["FulfillmentOrdersReadyForPickup"] = "FULFILLMENT_ORDERS_READY_FOR_PICKUP";
